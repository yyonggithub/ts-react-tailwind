...
export class ButtonGroup extends Component<ButtonGroupProps, State> {
  ...
  get classStr() {
    const orientation =
      this.props.orientation === "vertical" ? "-space-y-px" : "-space-x-px";
    const list = [
  ...
  getButtonList() {
    return this.props.options.map((item, index) => {
      ...
      const selectedColor =
        "selectedColor" in item ? item.selectedColor : this.selectedColor;
      const childColor =
        "childColor" in item ? item.childColor : this.childColor;
      const disabled = "disabled" in item ? item.disabled : this.props.disabled;
      const disabledColor =
        "disabledColor" in item ? item.disabledColor : this.disabledColor;
      ...
      const focusColor =
        "focusColor" in item ? item.focusColor : this.focusColor;
